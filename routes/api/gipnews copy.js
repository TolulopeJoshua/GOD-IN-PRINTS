...
const sects = ['world','sports','business','health','top','science,technology','entertainment','reel']
    // world: https://news67.p.rapidapi.com/v2/trending
    // sports: https://sportsdaily.p.rapidapi.com/api/sports/news/
    // business: https://biztoc.p.rapidapi.com/news/source/bbc
    // health: https://newsapi90.p.rapidapi.com/topic/health -- 0/48
    // top; https://news67.p.rapidapi.com/v2/feed
    // science: https://technology-news3.p.rapidapi.com/news
    // entertainment: https://cnn-api1.p.rapidapi.com/category -- 0/120 {url: 'https://edition.cnn.com/entertainment;}
    // extract: search extract -- news, media -- first item -- 500
                ...
                if (results && results.length) {
                    results = results.filter(article => {
                        ...
                        if (['cyprus-mail','pakistantoday','manicapost','scripts.24','Snl24','pajhwok','hmetro',
                            ...
                            'thezimbabwean.co','fiji','prnewswire','thepeninsulaqatar','247newsaroundtheworld',
                            'bulawayo24'
