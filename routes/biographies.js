...
const { isLoggedIn, isBiographyAuthor, validateBiography, isReviewAuthor, validateReview, setRedirect, isAdmin} = require('../middleware');
...
router.post('/writexml', isAdmin, catchAsync(biographies.writexml));
