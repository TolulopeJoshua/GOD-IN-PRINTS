...
export default function Navbar() {
  ...
  const navigation = [
    ...
    { name: 'Books', href: '/books', current: pathname.split('/')[1] == 'books' },
    { name: 'Biographies', href: '/biographies', current: pathname.split('/')[1] == 'biographies' },
    { name: 'Articles', href: '/articles', current: pathname.split('/')[1] == 'articles' },
  ]
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="flex rounded text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <span className='px-2 italic'>User</span>
                      {/* <img
