...
const UserSchema = new Schema({
    ...
    currentRead: { bookId: { type: Schema.Types.ObjectId, ref: 'Book' }, page: { type: Number, default: 1 }, lastRead: { type: Date, default: new Date() }, },
    watchLater: [ { type: String } ],
    isApproved: { type: Boolean, default: true },
    preferences: { nomail: {set: {type: Boolean, default: false}, time: Date}, },
    location: { loc: String, city: String, localRegion: String, countryCode: String, country: String, region: String, continent: String },
});
