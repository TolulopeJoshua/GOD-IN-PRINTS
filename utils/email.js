...
const sendWelcomeMail = (user) => {
    const options = {
        ...
        'Feel free to explore our little bank of resources and provide your feedbacks using our suggestion and <a href="https://godinprints.org#contact">contact</a> forms.',],
        farewell: 'Remain blessed'
    }
